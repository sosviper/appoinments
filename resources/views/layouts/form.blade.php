...
<head>
  ...
  <meta name="description" content="Sistema de Citas para Entidades Médicas">
  <meta name="author" content="Invoice 2 Peru">
      ...
      <div class="row align-items-center justify-content-xl-between">
        ...
        <div class="col-xl-6">
          <ul class="nav nav-footer justify-content-center justify-content-xl-end">
            <li class="nav-item">
              <a href="#" class="nav-link" target="_blank">Desarrollador</a>
            </li>
            <li class="nav-item">
